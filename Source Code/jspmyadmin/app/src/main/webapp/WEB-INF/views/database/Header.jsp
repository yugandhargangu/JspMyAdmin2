...
<div id="header-menu-container">
	<ul id="header-menu">
		...
		<li><a
			href="${pageContext.request.contextPath}/database_structure.html?token=${requestScope.command.request_token}"><img
		...
		<li><a
			href="${pageContext.request.contextPath}/database_view_list.html?token=${requestScope.command.request_token}"><img
		...
		<li><a
			href="${pageContext.request.contextPath}/database_procedures.html?token=${requestScope.command.request_token}"><img
		...
		<li><a
			href="${pageContext.request.contextPath}/database_functions.html?token=${requestScope.command.request_token}"><img
				alt="${lbl_functions}" class="icon"
				src="${pageContext.request.contextPath}/components/icons/historical.png">
				${lbl_functions}</a></li>
		<m:store name="lbl_events" key="lbl.events" />
		<li><a
			href="${pageContext.request.contextPath}/database_events.html?token=${requestScope.command.request_token}"><img
		...
		<li><a
			href="${pageContext.request.contextPath}/database_triggers.html?token=${requestScope.command.request_token}"><img
		...
		<li><a
			href="${pageContext.request.contextPath}/database_sql.html?token=${requestScope.command.request_token}"><img
		...
		<li><a
			href="${pageContext.request.contextPath}/database_export.html?token=${requestScope.command.request_token}"><img
		...
		<li><a
			href="${pageContext.request.contextPath}/database_import.html?token=${requestScope.command.request_token}"><img
		...
		<li><a
			href="${pageContext.request.contextPath}/database_privileges.html?token=${requestScope.command.request_token}"><img
