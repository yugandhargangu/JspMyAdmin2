						...
						<div class="group">
							...
							<div class="group-widget group-content">
								<div class="form-input">
									<label>Select Database(s)</label> <select name="databases"
										id="databases" class="form-control" multiple="multiple"
										size="25">
								...
								<div class="div-inline-item">
									...
									<div>
										<label><input type="radio" name="export_type"
											value="0"> Structure Only</label>
									</div>
									<div>
										<label><input type="radio" name="export_type"
											checked="checked" value="1"> Structure and Data</label>
									</div>
									<br>
									<div>
