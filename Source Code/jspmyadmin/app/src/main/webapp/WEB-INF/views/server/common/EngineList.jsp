		...
		<div id="main-content" style="width: calc(80% - 3px);">
			...
			<div id="main-body">
				<div style="padding: 0.2em 2em;">
					<div class="page-head">
						<h3>
							<m:print key="lbl.engine_list" />
						</h3>
					</div>
					<div class="group-widget group-content">
						<table class="tbl" id="engine-list">
							<thead>
								<tr>
									<jma:forLoop items="#columnInfo" name="columnName"
										scope="command" index="columnIndex">
										<th><a
											href="${pageContext.request.contextPath}/server_engines.html?token=${requestScope.command.sortInfo[columnIndex]}">
							...
							<tbody>
								<jma:notEmpty name="#data_list" scope="command">
									<jma:forLoop items="#data_list" name="engineInfo"
										scope="command">
										<tr>
											<jma:forLoop items="#engineInfo" name="engineData"
												scope="page">
												<td>${engineData}</td>
											</jma:forLoop>
										</tr>
								...
								<jma:empty name="#data_list" scope="command">
									<tr class="even">
										<td colspan="8"><m:print key="msg.no_engine_found" /></td>
									</tr>
								</jma:empty>
							</tbody>
						</table>
