...
public class ViewDropController extends Controller<StructureBean> {
	...
	protected void handlePost(StructureBean bean, View view) throws Exception {
		...
		try {
			...
			redirectParams.put(FrameworkConstants.MSG_KEY, AppConstants.MSG_VIEW_DROPPED_SUCCESSFULLY);
		} catch (Exception e) {
