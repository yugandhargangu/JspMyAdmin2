...
public class DuplicateController extends Controller<StructureBean> {
	...
	protected void handlePost(StructureBean bean, View view) throws Exception {
		...
		try {
			...
			redirectParams.put(FrameworkConstants.MSG_KEY, AppConstants.MSG_DUPLICATE_TABLE_SUCCESSFULLY);
		} catch (Exception e) {
