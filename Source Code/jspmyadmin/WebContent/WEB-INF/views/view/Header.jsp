...
<div id="header-menu-container">
	<ul id="header-menu">
		...
		<li><a href="${pageContext.request.contextPath}/view_data.html"><img
		...
		<li><a
			href="${pageContext.request.contextPath}/view_structure.html"><img
		...
		<li><a href="${pageContext.request.contextPath}/view_sql.html"><img
		...
		<li><a href="${pageContext.request.contextPath}/view_import.html"><img
