...
function callDatabase(element, name) {
	...
	if (src.indexOf('plus-g') >= 0) {
		...
		html += '<div><a href="';
		html += Server.root;
		html += '/database_view_list.html?token=';
		html += name;
		html += '"><img alt="db" class="icon" src="';
		html += Server.root;
		html += '/components/icons/pages.png"> <span>';
		...
		html += '<div><a href="';
		html += Server.root;
		html += '/database_procedures.html?token=';
		html += name;
		html += '"><img alt="db" class="icon" src="';
		html += Server.root;
		html += '/components/icons/pages.png"> <span>';
		...
		html += '<div><a href="';
		html += Server.root;
		html += '/database_events.html?token=';
		html += name;
		html += '"><img alt="db" class="icon" src="';
		html += Server.root;
		html += '/components/icons/pages.png"> <span>';
		...
		html += '<div><a href="';
		html += Server.root;
		html += '/database_functions.html?token=';
		html += name;
		html += '"><img alt="db" class="icon" src="';
		html += Server.root;
		html += '/components/icons/pages.png"> <span>';
		...
		html += '<div><a href="';
		html += Server.root;
		html += '/database_triggers.html?token=';
		html += name;
		html += '"><img alt="db" class="icon" src="';
		html += Server.root;
		html += '/components/icons/pages.png"> <span>';
