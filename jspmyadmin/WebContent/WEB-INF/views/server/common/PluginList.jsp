						...
						<table class="tbl" id="plugin-list">
							...
							<tbody>
								<jma:notEmpty name="#data_list" scope="command">
									<jma:forLoop items="#data_list" name="pluginInfo"
										scope="command">
										<tr>
											<jma:forLoop items="#pluginInfo" name="pluginData"
												scope="page">
												<td>${pluginData}</td>
											</jma:forLoop>
										</tr>
								...
								<jma:empty name="#data_list" scope="command">
									<tr class="even">
										<td colspan="8"><m:print key="msg.no_plugin_found" /></td>
									</tr>
								</jma:empty>
							</tbody>
						</table>
