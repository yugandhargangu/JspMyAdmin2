...
public class ForeignKeyLogic extends AbstractLogic {
	 ...
	 */
	public String fetchColumns() throws ClassNotFoundException, SQLException, JSONException {
		String result = null;
		...
		try {
			apiConnection = getConnection(true);
			statement = apiConnection.preparedStatementSelect("SHOW COLUMNS FROM `" + _table + "`");
			resultSet = statement.executeQuery();
