 ...
 *
 */
@WebController(authentication = true, path = "/database_event_disable")
public class DisableController extends Controller<EventListBean> {
