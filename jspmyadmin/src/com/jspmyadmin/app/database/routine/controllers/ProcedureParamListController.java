 ...
 *
 */
@WebController(authentication = true, path = "/database_procedure_params.text")
public class ProcedureParamListController extends Controller<RoutineListBean> {
	...
	protected void handlePost(RoutineListBean bean, View view) throws Exception {
		...
		try {
			...
			String result = routineLogic.getParamList(bean, "PROCEDURE");
