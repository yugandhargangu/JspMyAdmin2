...
public class DatabaseInfo implements Serializable {
	 ...
	 *
	 */
	public static class DatabaseInfoComparator implements
			Comparator<DatabaseInfo> {
			...
			if (_sortInfo == null) {
				...
				try {
					...
					case 1:
						...
						_sortInfo.setCollation(encDecLogic.encode(jsonObject
								.toString()));

						jsonObject = new JSONObject();
						jsonObject.put(FrameworkConstants.NAME, 2);
						jsonObject.put(FrameworkConstants.TYPE, false);
						_sortInfo.setTables(encDecLogic.encode(jsonObject
								.toString()));

						jsonObject = new JSONObject();
						jsonObject.put(FrameworkConstants.NAME, 3);
						jsonObject.put(FrameworkConstants.TYPE, false);
						_sortInfo.setRows(encDecLogic.encode(jsonObject
								.toString()));

						jsonObject = new JSONObject();
						jsonObject.put(FrameworkConstants.NAME, 4);
						jsonObject.put(FrameworkConstants.TYPE, false);
						_sortInfo.setData(encDecLogic.encode(jsonObject
								.toString()));

						jsonObject = new JSONObject();
						jsonObject.put(FrameworkConstants.NAME, 5);
						jsonObject.put(FrameworkConstants.TYPE, false);
						_sortInfo.setIndexes(encDecLogic.encode(jsonObject
								.toString()));

						jsonObject = new JSONObject();
						jsonObject.put(FrameworkConstants.NAME, 6);
						jsonObject.put(FrameworkConstants.TYPE, false);
						_sortInfo.setTotal(encDecLogic.encode(jsonObject
								.toString()));

						jsonObject = new JSONObject();
						jsonObject.put(FrameworkConstants.NAME, 0);
						jsonObject.put(FrameworkConstants.TYPE, false);
						_sortInfo.setDatabase(encDecLogic.encode(jsonObject
								.toString()));
						break;
					case 2:
						jsonObject = new JSONObject();
		...
		public int compare(DatabaseInfo info1, DatabaseInfo info2) {
			...
			case 2:
				if (_type) {
					if (Integer.parseInt(info1.tables) > Integer
							.parseInt(info2.tables)) {
						return 1;
					} else if (Integer.parseInt(info1.tables) < Integer
							.parseInt(info2.tables)) {
						return -1;
					} else {
						return 0;
			...
			case 3:
				if (_type) {
					if (Integer.parseInt(info1.rows) > Integer
							.parseInt(info2.rows)) {
						return 1;
					} else if (Integer.parseInt(info1.rows) < Integer
							.parseInt(info2.rows)) {
						return -1;
					} else {
						return 0;
			...
			case 4:
				if (_type) {
					if (Double.parseDouble(info1.data) > Double
							.parseDouble(info2.data)) {
						return 1;
					} else if (Double.parseDouble(info1.data) < Double
							.parseDouble(info2.data)) {
						return -1;
					} else {
						return 0;
			...
			case 5:
				if (_type) {
					if (Double.parseDouble(info1.indexes) > Double
							.parseDouble(info2.indexes)) {
						return 1;
					} else if (Double.parseDouble(info1.indexes) < Double
							.parseDouble(info2.indexes)) {
						return -1;
					} else {
						return 0;
			...
			case 6:
				if (_type) {
					if (Double.parseDouble(info1.total) > Double
							.parseDouble(info2.total)) {
						return 1;
					} else if (Double.parseDouble(info1.total) < Double
							.parseDouble(info2.total)) {
						return -1;
					} else {
						return 0;
