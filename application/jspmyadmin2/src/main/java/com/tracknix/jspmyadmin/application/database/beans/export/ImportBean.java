package com.tracknix.jspmyadmin.application.database.beans.export;

import com.tracknix.jspmyadmin.framework.web.utils.Bean;
import com.tracknix.jspmyadmin.framework.web.utils.FileInput;
...
public class ImportBean extends Bean {
    ...
    /**
     * @param import_file the import_file to set
     */
    ...
    /**
     * @param continue_errors the continue_errors to set
     */
    ...
    /**
     * @param error_queries the error_queries to set
     */
    ...
    /**
     * @param import_to_db the import_to_db to set
     */
    ...
    /**
     * @param ignore_count the ignore_count to set
     */
