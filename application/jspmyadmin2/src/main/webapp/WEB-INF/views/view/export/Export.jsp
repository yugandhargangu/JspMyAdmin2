		...
		<div id="main-content" style="width: calc(80% - 3px);">
			...
			<div id="main-body">
				<div style="padding: 0.1em 0.2em;">
					<div class="page-head">
						<h3>
							<m:print key="lbl.view_export" />
						</h3>
					</div>
					<form action="${pageContext.request.contextPath}/view_export.html"
						...
						<input type="hidden" name="request_db"
							...
							type="hidden" name="request_view"
							value="${requestScope.command.request_view}"> <input
							type="hidden" name="token" id="token"
							value="${requestScope.command.token}">

						<div class="group">
							<div class="group-widget group-header">
								<m:print key="lbl.export_information" />
							</div>
							<div class="group-widget group-content">
								<div class="div-inline-item">
									<h4>
										<m:print key="lbl.select_columns" />
									</h4>
									<div>
								...
								<div class="div-inline-item">
									...
									<br>
									<div class="form-input">
										<label><m:print key="lbl.export_type" /> </label> <select
											name="export_type" class="form-control">
