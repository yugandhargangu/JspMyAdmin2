...
public class RoutineBean extends Bean {
    ...
    /**
     * @param param_types the param_types to set
     */
    ...
    /**
     * @param param_data_types the param_data_types to set
     */
    ...
    /**
     * @param return_length the return_length to set
     */
    ...
    /**
     * @param lang_sql the lang_sql to set
     */
    ...
    /**
     * @param sql_security the sql_security to set
     */
    ...
    /**
     * @param new_column the new_column to set
     */
    ...
    /**
     * @param data_types_map the data_types_map to set
     */
    ...
    /**
     * @param sql_type_list the sql_type_list to set
     */
    ...
    /**
     * @param security_type_list the security_type_list to set
     */
