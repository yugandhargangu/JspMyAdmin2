...
public class RoutinePrivilegeBean extends Bean {
    ...
    /**
     * @param procedure_list the procedure_list to set
     */
    ...
    /**
     * @param function_list the function_list to set
     */
    ...
    /**
     * @param procedure_privileges the procedure_privileges to set
     */
    ...
    /**
     * @param function_privileges the function_privileges to set
     */
