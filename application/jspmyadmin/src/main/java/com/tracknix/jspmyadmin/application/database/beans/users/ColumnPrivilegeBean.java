package com.tracknix.jspmyadmin.application.database.beans.users;
...
public class ColumnPrivilegeBean extends Bean {
    ...
    /**
     * @param column_list the column_list to set
     */
    ...
    /**
     * @param select_column_list the select_column_list to set
     */
    ...
    /**
     * @param insert_column_list the insert_column_list to set
     */
    ...
    /**
     * @param update_column_list the update_column_list to set
     */
    ...
    /**
     * @param reference_column_list the reference_column_list to set
     */
    ...
    /**
     * @param select_columns the select_columns to set
     */
    ...
    /**
     * @param insert_columns the insert_columns to set
     */
    ...
    /**
     * @param update_columns the update_columns to set
     */
    ...
    /**
     * @param reference_columns the reference_columns to set
     */
    ...
    /**
     * @param table_token the table_token to set
     */
