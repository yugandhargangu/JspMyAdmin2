...
public class TriggerBean extends Bean {
    ...
    /**
     * @param definer_name the definer_name to set
     */
    ...
    /**
     * @param trigger_event the trigger_event to set
     */
    ...
    /**
     * @param trigger_order the trigger_order to set
     */
    ...
    /**
     * @param trigger_body the trigger_body to set
     */
    ...
    /**
     * @param definer_list the definer_list to set
     */
    ...
    /**
     * @param trigger_time_list the trigger_time_list to set
     */
    ...
    /**
     * @param trigger_event_list the trigger_event_list to set
     */
    ...
    /**
     * @param database_name_list the database_name_list to set
     */
    ...
    /**
     * @param trigger_order_list the trigger_order_list to set
     */
    ...
    /**
     * @param other_trigger_name the other_trigger_name to set
     */
    ...
    /**
     * @param other_trigger_name_list the other_trigger_name_list to set
     */
