...
<body>
			...
			<div id="main-body">
				<div style="padding: 0.1em 0.2em;">
					...
					<jma:notEmpty name="#success_count" scope="command">
						<div class="group">
							<div class="group-widget group-header">Success Result</div>
							<div class="group-widget group-content">
								<div style="color: green;">Total Number of Queries
									Processed: ${requestScope.command.success_count}</div>
							</div>
						</div>
					</jma:notEmpty>
					<jma:notEmpty name="#error_count" scope="command">
						<div class="group">
							<div class="group-widget group-header">Error Result</div>
							<div class="group-widget group-content">
								<div style="color: red;">Total Number of Error Queries:
									${requestScope.command.error_count}</div>
					...
					<jma:notEmpty name="#ignore_count" scope="command">
						<div class="group">
							<div class="group-widget group-header">Ignore Result</div>
							<div class="group-widget group-content">
								<div style="color: #FFCC00;">Total Number of Queries
									Ignored: ${requestScope.command.ignore_count}</div>
							</div>
						</div>
					</jma:notEmpty>
				</div>
	...
	<script type="text/javascript">
		$("#header-menu li:nth-child(9)").addClass('active');
